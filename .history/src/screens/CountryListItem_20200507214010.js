        ...
        return (
            ...
            <Card>
                ...
                {/* <View style={photoDescriptionContainer}> */}
                    ...
                    <CardSection>
                        <Text style={styles.title}>Country: {country.name}</Text>
                    </CardSection>
                    <CardSection>
                        <Text style={styles.subTitle}>Capital: {country.capital}</Text>
                    </CardSection>
                    <CardSection>
                        <Text style={styles.subTitle}>Time Zones: {country.timezones}</Text>
                    </CardSection>
                    <CardSection>
