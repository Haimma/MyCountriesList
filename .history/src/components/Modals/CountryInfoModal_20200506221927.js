...
const CountryInfoModal = ({ children, visible, onUpdate, onClose, imageContainer, countryIn }) => {
    const { containerStyle, leftTextStyle, rightTextStyle, cardSectionStyle, image } = styles;
    return (
        <Modal
            visible = {visible}
            transparent
        ...
        >
            <View style = { containerStyle }>
                {/* <CardSection style = { imageContainer }>
                    <SvgUri 
                        style={image}
                        uri={ children.flag }
                        resizeMode="cover"
